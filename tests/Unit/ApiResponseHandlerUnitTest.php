...
class ApiResponseHandlerUnitTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        if (!Schema::hasTable('people')) {
            include_once __DIR__ . '/../../database/migrations/2025_11_07_130200_create_people_table.php';
            (new \CreatePeopleTable)->up();
        }
        
        if (!Schema::hasTable('addresses')) {
            include_once __DIR__ . '/../../database/migrations/2025_11_07_130100_create_addresses_table.php';
            (new \CreateAddressesTable)->up();
        }
    }

    /** @test */
    public function it_processes_person_response()
    {
        // Clear existing data
